...
//               <tr key={`${order.id}-${index}`} className="border-b"> {/* 🔴 Ensuring Unique Keys */}
...
// export default OrderList;    //Before the below code-the code with order status and error fixed
